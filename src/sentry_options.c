...
void
sentry_options_set_attach_session_replay(sentry_options_t *opts, int val)
{
    opts->attach_session_replay = !!val;
}
...
{
    opts->before_send_metric_func = func;
    opts->before_send_metric_data = user_data;
}
